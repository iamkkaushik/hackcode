      ...
      <div className="container mx-auto px-4">
        ...
        <div className="p-2 rounded-lg shadow-md">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            <button onClick={() => handleModalOpen(helpCenterContent)} className="hover:text-blue-400 transition duration-300">
              Help Center
            </button>
            <button onClick={() => handleModalOpen(bugBountyContent)} className="hover:text-blue-400 transition duration-300">
              Bug Bounty
            </button>
            <button onClick={() => handleModalOpen(termsContent)} className="hover:text-blue-400 transition duration-300">
              Terms
            </button>
            <button onClick={() => handleModalOpen(privacyPolicyContent)} className="hover:text-blue-400 transition duration-300">
              Privacy Policy
            </button>
          </div>
